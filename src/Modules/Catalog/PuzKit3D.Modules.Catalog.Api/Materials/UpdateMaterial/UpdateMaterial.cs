...
internal sealed class UpdateMaterial : IEndpoint
{
    public void MapEndpoint(IEndpointRouteBuilder app)
    {
        app.MapMaterialsGroup()
            ...
            .WithDescription("Updates an existing material with new name, slug, description, and active status. Requires Staff or Manager permission.")
            .RequireAuthorization(Permissions.Catalog.ManageMaterials)
