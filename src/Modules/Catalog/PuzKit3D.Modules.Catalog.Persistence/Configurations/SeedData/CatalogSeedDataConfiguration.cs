...
internal static class CatalogSeedDataConfiguration
{
    ...
    public static void SeedCatalogMasterData(this ModelBuilder modelBuilder)
    {
        ...
        SeedAssemblyMethods(modelBuilder);
    }
    ...
    private static void SeedCapabilities(ModelBuilder modelBuilder)
    {
    ...
    private static void SeedAssemblyMethods(ModelBuilder modelBuilder)
    {
