...
public sealed class AwsSesEmailService : IEmailService
{
    ...
    public async Task SendVerifyEmailAsync(string toEmail, string userId, string token)
    {
        ...
        {
            Source = _emailSettings.SenderEmail,
            Template = EmailTemplate.VerifyEmailTemplate,
    ...
    public async Task InitializeEmailTemplate()
    {
        ...
        var verifyEmailTemplate = new CreateTemplateRequest
        {
            Template = new Template
            {
                ...
                <head>
                	<meta charset="UTF-8">
                	<title>Verify Your Email | PuzKit3D</title>
                	<style>
                			...
                			<tr>
                				<td>
                					<div class="content">
                						...
                						Thank you for registering at PuzKit3D.<br>
