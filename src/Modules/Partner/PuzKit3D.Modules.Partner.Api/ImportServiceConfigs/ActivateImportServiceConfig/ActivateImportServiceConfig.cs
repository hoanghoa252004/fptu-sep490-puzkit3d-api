...
using PuzKit3D.Modules.Partner.Application.UseCases.ImportServiceConfigs.Commands.ActivateImportServiceConfig;
using PuzKit3D.SharedKernel.Api.Endpoint;
using PuzKit3D.SharedKernel.Api.Results.Extensions;
using PuzKit3D.SharedKernel.Application.Authorization;

namespace PuzKit3D.Modules.Partner.Api.ImportServiceConfigs.ActivateImportServiceConfig;

internal sealed class ActivateImportServiceConfig : IEndpoint
{
    public void MapEndpoint(IEndpointRouteBuilder app)
    {
        app.MapImportServiceConfigsGroup()
            ...
            {
                var command = new ActivateImportServiceConfigCommand(id);
