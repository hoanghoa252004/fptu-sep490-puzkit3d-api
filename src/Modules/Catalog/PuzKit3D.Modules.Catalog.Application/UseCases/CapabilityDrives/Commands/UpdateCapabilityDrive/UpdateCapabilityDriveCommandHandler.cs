...
internal sealed class UpdateCapabilityDriveCommandHandler : ICommandHandler<UpdateCapabilityDriveCommand>
{
    private readonly ICapabilityDriveRepository _capabilityDriveRepository;
    private readonly ICatalogUnitOfWork _unitOfWork;

    public UpdateCapabilityDriveCommandHandler(
    ...
    public async Task<Result> Handle(UpdateCapabilityDriveCommand request, CancellationToken cancellationToken)
    {
        ...
        return await _unitOfWork.ExecuteAsync(async () =>
        {
            ...
            {
                capabilityDrive.UpdateQuantity(request.Quantity.Value);
            }

            _capabilityDriveRepository.Update(capabilityDrive);
